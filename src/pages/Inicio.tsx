...
import { Shield, LayoutDashboard, Accessibility, Share2, FileText, ShieldAlert } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-zinc-950 dark:to-zinc-900 pt-28 pb-16 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-pink-400 to-sky-400 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {sections.map((section, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-zinc-900 dark:text-zinc-100 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-sky-400 group-hover:bg-clip-text transition-all">
                {section.title}
              </h3>
        ...
        {/* CTA Section */}
        <div className="text-center bg-gradient-to-r from-pink-400 to-sky-400 rounded-2xl p-8 text-white shadow-xl">
          ...
          <Link
            to="/plantillas"
            className="inline-block bg-white text-pink-500 px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition-all hover:scale-105"
          >
            Ver Plantillas
          </Link>
        </div>
